...
public class RecordingPresenter {
    ...
    public boolean saveRecording(Task task, HashMap<Integer,RecordingContent> recordingMap){
    ...
    public HashMap<Integer, RecordingContent> insertRecording(HashMap<Integer, RecordingContent> oldMap, List<String> text, int index, String filePath, String type) {
        ...
        if(text != null && oldMap != null){
            ...
            if(number > 1){
                ...
                if(text.get(number - 1).charAt(0) == '\n')
                    newStr = text.get(number - 1).substring(1);
                else
                    newStr = text.get(number - 1);
                content.setContent(newStr);
